...
const Switch = () => {
    ...
    // Determine if checked based on theme. Default to false (light) if system or unknown.
    // If you want 'system' to be handled, it might be complex with a simple toggle.
    // We'll assume toggle switches between light and dark.
...
const StyledWrapper = styled.div`
  ...
  .bb8-toggle {
    --toggle-size: 10px; /* Adjusted size to fit navbar */
